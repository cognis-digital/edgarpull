"""Native cognis-connect emit for edgarpull — forward findings to any platform.

Maps edgarpull's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    edgarpull ... --format json | edgarpull-emit --to stix
    edgarpull-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
